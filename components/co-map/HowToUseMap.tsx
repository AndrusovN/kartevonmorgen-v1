...
const instructions = [
  {
    ...
    image: "/../public/co-map/current_location.png",
    instruction: 'Заходите в гости к лидерам изменений, которые заботятся об окружающих и о будущем.',
  ...
  },
  {
    ...
    image: "/../public/co-map/right_direction.png",
    instruction: 'Расскажите об организациях и проектах в вашем районе, которые вас вдохновляют',
  ...
  },
  {
    ...
    image: "/../public/co-map/winners.png",
    instruction: 'Оставляйте отзывы и оценивайте лидеров изменений по специальным критериям',
