...

      {
        shouldCreateANewEntity && (
          ...
          >
            ...
            <Select.Option value={Category.COMPANY}>{t('entryForm.category.company')}</Select.Option>
            <Select.Option value={Category.EVENT}>{t('entryForm.category.event')}</Select.Option>
          </Select>
        )
      }
